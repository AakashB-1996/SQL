...
select distinct l.account_id from LogInfo l, Loginfo r ##l is for earlier login details
where l.account_id = r.account_id
and l.ip_address <> r.ip_address
and l.login <= r.login and l.logout >= r .login ##filters out where there is an overlap between login sessions
